...
xinit_Robust  = [.06 0 0 0 0 0 -.06 0 0 0 0 0 0 0]';    % [right left]
xfinal_Robust = [.06 .15 0 0 0 0 -.06 .15 0 0 0 0 0 0.15]';% [right left] 
...
for trial = 1:numoftrials
    ...
    plot(-0.06,0,'ro','LineWidth',2);
    plot(-0.06,.15,'ro','MarkerSize',10,'LineWidth',2);
    xlabel('x-coord [m]'); ylabel('y-coord [m]'); title(['LQG (L) and Robust (R) models - 1 cursor - trajectories'],'FontSize',14);
